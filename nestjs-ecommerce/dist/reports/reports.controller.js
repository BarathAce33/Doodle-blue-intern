...
__decorate([
    (0, common_1.Get)('orders/csv'),
    (0, common_1.Header)('Content-Type', 'text/csv'),
    (0, common_1.Header)('Content-Disposition', 'attachment; filename=orders-report.csv'),
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(reports_validator_1.GetReportSchema)),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getOrdersCsv", null);
